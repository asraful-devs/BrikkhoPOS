...
const createWeeklySummary = async (req: Request) => {
...
const getAllWeeklySummaries = async (
    ...
    const whereConditions: Prisma.WeeklySummaryWhereInput =
...
const getSingleWeeklySummary = async (req: Request) => {
    const { id } = req.params;
...
const updateWeeklySummary = async (req: Request) => {
    const { id } = req.params;
    const payload = req.body;
...
const deleteWeeklySummary = async (req: Request) => {
    const { id } = req.params;
