...
const CreateWeeklySummary = catchAsync(async (req: Request, res: Response) => {
...
const GetAllWeeklySummaries = catchAsync(
    async (req: Request, res: Response) => {
        ...
        const result = await WeeklySummaryService.getAllWeeklySummaries(
            filters,
            options
        );
...
const GetSingleWeeklySummary = catchAsync(
    async (req: Request, res: Response) => {
...
const UpdateWeeklySummary = catchAsync(async (req: Request, res: Response) => {
...
const DeleteWeeklySummary = catchAsync(async (req: Request, res: Response) => {
...
const GenerateWeeklyReport = catchAsync(async (req: Request, res: Response) => {
