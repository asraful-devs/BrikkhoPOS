...
router.post('/create-user', validateRequest(userVaildation.createUserZodSchema), UserController.CreateUser);
...
router.patch('/update-user/:id', validateRequest(userVaildation.updateUserZodSchema), UserController.UpdateUser);
